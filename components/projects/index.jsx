    ...
    <section id="projects" className="mt-10 md:mt-20 lg:my-32">
      ...
      <div>
        <div className="mb-4 flex items-center justify-between md:mb-6">
          <a
            className="text-2xl font-bold duration-200 hover:opacity-80 md:text-4xl md:font-extrabold"
        ...
        <div className="my-4 flex items-center justify-between md:my-6">
          ...
          <p className="text-lg font-bold">Oct 2022 - Nov 2022</p>
        </div>
        <div className="my-4 flex items-center justify-between md:my-6">
          <a
            className="text-2xl font-bold duration-200 hover:opacity-80 md:text-4xl md:font-extrabold"
          ...
          <p className="text-lg font-bold">Jun 2022 - Dec 2022</p>
        </div>
        <div className="my-4 flex items-center justify-between md:my-6">
          <a
            className="text-2xl font-bold duration-200 hover:opacity-80 md:text-4xl md:font-extrabold"
          ...
          <p className="text-lg font-bold">Sep 2021 - May 2022</p>
        </div>
        <div className="my-4 flex items-center justify-between md:my-6">
          <a
            className="text-2xl font-bold duration-200 hover:opacity-80 md:text-4xl md:font-extrabold"
          ...
          <p className="text-lg font-bold">Fev 2021 - Aug 2022</p>
        </div>
        <div className="my-4 flex items-center justify-between md:my-6">
          <a
            className="text-2xl font-bold duration-200 hover:opacity-80 md:text-4xl md:font-extrabold"
          ...
          <p className="text-lg font-bold">Mar 2022 - Jul 2022</p>
        </div>
      </div>
    </section>
  );
